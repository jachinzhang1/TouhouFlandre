...
type PixivIconProps = Omit<SVGProps<SVGSVGElement>, "height" | "width"> & {
  size?: number;
};

// Path sourced from Simple Icons' pixiv icon (CC0-1.0).
export function PixivIcon({ size = 24, ...props }: PixivIconProps) {
  return (
    <svg
      fill="currentColor"
      height={size}
