...
type BilibiliIconProps = Omit<SVGProps<SVGSVGElement>, "height" | "width"> & {
  size?: number;
};

// Path sourced from Lobe Icons' Bilibili Mono icon (MIT).
export function BilibiliIcon({ size = 24, ...props }: BilibiliIconProps) {
  return (
    <svg
      fill="currentColor"
      fillRule="evenodd"
