  ...
  return (
    <>
      <section className="px-[18px] pt-12 pb-6 max-[680px]:pt-[34px] max-[680px]:pb-[18px]">
        ...
        <div className="mt-[34px] grid max-w-[1100px] grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-[14px] max-[680px]:mt-[26px] max-[680px]:grid-cols-1">
          ...
          <button
            type="button"
            className="group grid min-h-[205px] gap-4 rounded-[6px] border border-line bg-paper p-[23px] text-left text-ink shadow-sm transition-[border-color,box-shadow,transform] duration-180 hover:-translate-y-[3px] hover:border-[var(--accent-hover-border)] hover:shadow-lg max-[680px]:min-h-[185px]"
          ...
          >
            ...
            <span className="leading-[1.6] text-ink-soft">自定义出题范围</span>
          </button>
        </div>
      </section>
      <QuestionScopeDialog
